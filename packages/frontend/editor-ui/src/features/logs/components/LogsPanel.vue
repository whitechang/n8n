...
const {
	...
	onToggleOpen,
	onPopOut,
	// onChatPanelResize removed,
	// onChatPanelResizeEnd removed,
...
const { entries, execution, latestNodeNameById, resetExecutionData, loadSubExecution } =
